...
export const translations = {
  en: {
    ...
    chat: {
      ...
      generatingCode: 'Generating JSCAD code...',
    ...
    messages: {
      ...
      compilingJSCAD: 'Compiling JSCAD code...',
      processingGeometry: 'Processing geometry...',
      pleaseWaitRendering: 'Please wait, rendering may take a moment...',
  ...
  fr: {
    ...
    chat: {
      ...
      generatingCode: 'Génération du code JSCAD...',
    ...
    messages: {
      ...
      rendering3D: 'Rendu du modèle 3D...',
      compilingJSCAD: 'Compilation du code JSCAD...',
      processingGeometry: 'Traitement de la géométrie...',
      pleaseWaitRendering: 'Veuillez patienter, le rendu peut prendre un moment...',
